...
import {assessRoutes} from '../router'
...
@Component({
  selector: 'app-assess-index',
  templateUrl: './assess-index.component.html',
  styleUrls: ['./assess-index.component.css']
})

export class AssessIndexComponent implements OnInit,OnDestroy {
	//id = 'abc';
	id="";
  isCollapsed = false;
  
  menuList=assessRoutes;
